...
description: My experience uploading the relagit package to the Arch User Repository, including PKGBUILD creation, testing, and publishing.
author: Lenin AGC
date: 2024-05-07 9:15:00
cover: /images/blog/post10_img0.webp
...
2. **Create a PKGBUILD file:** The PKGBUILD file contains the instructions for building and packaging the software. It specifies the package name, version, dependencies, and build steps:
...
3. **Create checksums:** The checksums file contains the SHA-256 checksums of the files in the package. It is used to verify the integrity of the package.

```bash
updpkgsums
```

4. **Test the package locally:** Before uploading the package to the AUR, it's crucial to test it locally to ensure it builds and installs correctly.

```bash
makepkg -si
```

5. **Push the package to the AUR:** After creating the repository, you can push your PKGBUILD and related files to the AUR using Git.
